...
from app.views.reservation import reservation_view
...
urlpatterns = [
    ...
    url(r'^reservation/$', reservation_view, name='reservation'),
    url(r'^reservation/(?P<pk>[0-9]+)/$', reservation_view, name='reservation_pk'),
    #Paypal
